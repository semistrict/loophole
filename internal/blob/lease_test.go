...
func TestLeaseAcquireCreatesFile(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		mem := NewMemDriver()
		store := New(mem)
		lm := NewLeaseSession(store.At("leases"))

		require.NoError(t, lm.EnsureStarted(t.Context()))

		data, ok := mem.GetObject("leases/" + lm.Token() + ".json")
...
func TestLeaseCloseDeletesFile(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		...
		_, ok := mem.GetObject("leases/" + token + ".json")
...
func TestLeaseTokenIsUnique(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		...
		a := NewLeaseSession(leases)
		b := NewLeaseSession(leases)
...
func TestCheckAvailableLiveHolder(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		...
		store := New(mem)
		leases := store.At("leases")
		holder := NewLeaseSession(leases)
		require.NoError(t, holder.EnsureStarted(t.Context()))

		challenger := NewLeaseSession(leases)
...
func TestCheckAvailableAfterCrashAutoBreaks(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		...
		// File still exists.
		_, ok := mem.GetObject("leases/" + holderToken + ".json")
		assert.True(t, ok)
...
func TestCheckAvailableLiveHolderNotBroken(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		...
		_, ok := mem.GetObject("leases/" + holder.Token() + ".json")
		assert.True(t, ok)
...
func TestCheckAvailableAutoBreakCleansUpLeaseFile(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		...
		_, ok := mem.GetObject("leases/" + deadToken + ".json")
		assert.False(t, ok)
