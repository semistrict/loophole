module github.com/semistrict/loophole
...
require (
	...
	go.podman.io/storage v0.0.0-00010101000000-000000000000
...
replace go.podman.io/storage => ./third_party/container-libs/storage
