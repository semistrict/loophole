...
const (
	...
	// FlagSendWriteZeroes is set if the export supports the WriteZeroes command.
	FlagSendWriteZeroes ServerFlags = 1 << 6
	// FlagCanMulticonn is set if the export can serve multiple connections.
	FlagCanMulticonn ServerFlags = 1 << 8
	// FlagSendFastZero is set if the export supports fast zero detection.
	FlagSendFastZero ServerFlags = 1 << 11
)
